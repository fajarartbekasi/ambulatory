            ...
            <div class="max-w-sm mx-auto rounded-lg overflow-hidden">
                <div class="sm:flex sm:items-center px-6 py-4">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                        ...
                        <a :href="'/'+Ambulatory.path+'/logout'" class="text-sm leading-tight text-gray-600 hover:text-blue-600">
                            Logout
                        </a>
                    </div>
                </div>
                <ul class="list-reset">
                    <li class="pt-8 ml-6">
                        <router-link active-class="active"
                                     to="/inbox"
                                     class="text-blue-600 text-xl flex items-center hover:text-teal-400"
                                     >
                    ...
                    <li class="pt-8 ml-6" v-if="Ambulatory.user.role === 'doctor'">
                        <router-link active-class="active"
                                     to="/schedules"
                                     class="text-gray-700 flex items-center hover:text-teal-400">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 512 512"
                                 width="24px"
                                 height="24px"
